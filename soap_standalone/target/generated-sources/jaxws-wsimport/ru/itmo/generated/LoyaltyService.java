    ...
    extends Service
{
    ...
    public LoyaltyService(WebServiceFeature... features) {
        super(__getWsdlLocation(), LOYALTYSERVICE_QNAME, features);
    }

    public LoyaltyService(URL wsdlLocation) {
        super(wsdlLocation, LOYALTYSERVICE_QNAME);
    }

    public LoyaltyService(URL wsdlLocation, WebServiceFeature... features) {
        super(wsdlLocation, LOYALTYSERVICE_QNAME, features);
    }

    public LoyaltyService(URL wsdlLocation, QName serviceName) {
        super(wsdlLocation, serviceName);
    }

    public LoyaltyService(URL wsdlLocation, QName serviceName, WebServiceFeature... features) {
     ...
     * 
     * @return
     *     returns LoyaltyWebService
     */
    @WebEndpoint(name = "LoyaltyServicePort")
    public LoyaltyWebService getLoyaltyServicePort() {
        return super.getPort(new QName("http://itmo.ru/", "LoyaltyServicePort"), LoyaltyWebService.class);
    }
     ...
     */
    @WebEndpoint(name = "LoyaltyServicePort")
    public LoyaltyWebService getLoyaltyServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://itmo.ru/", "LoyaltyServicePort"), LoyaltyWebService.class, features);
    }
